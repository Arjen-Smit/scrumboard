...
/**
 * Base class that represents a row from the 'project_tab' table.
 *
 *
 *
 * @package    propel.generator.Scrumboard.om
 */
abstract class BaseProjectTab extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ScrumBoard\\ProjectTabPeer';
     ...
     * @return ProjectTab The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ProjectTabPeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectTabPeer::NAME;
        }
    ...
    public function setPosition($v)
    {
        ...
        if ($this->position !== $v) {
            $this->position = $v;
            $this->modifiedColumns[] = ProjectTabPeer::POSITION;
        }
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->project_id !== $v) {
            $this->project_id = $v;
            $this->modifiedColumns[] = ProjectTabPeer::PROJECT_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->project_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = ProjectTabPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectTab object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectTabPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectTabQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProjectTabPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectTabPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ProjectTabPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(ProjectTabPeer::POSITION)) {
            $modifiedColumns[':p' . $index++]  = '`position`';
        }
        if ($this->isColumnModified(ProjectTabPeer::PROJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`project_id`';
        }

        $sql = sprintf(
            'INSERT INTO `project_tab` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectTabPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectTabPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectTab'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectTab'][$this->getPrimaryKey()] = true;
        $keys = ProjectTabPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectTabPeer::ID)) $criteria->add(ProjectTabPeer::ID, $this->id);
        if ($this->isColumnModified(ProjectTabPeer::NAME)) $criteria->add(ProjectTabPeer::NAME, $this->name);
        if ($this->isColumnModified(ProjectTabPeer::POSITION)) $criteria->add(ProjectTabPeer::POSITION, $this->position);
        if ($this->isColumnModified(ProjectTabPeer::PROJECT_ID)) $criteria->add(ProjectTabPeer::PROJECT_ID, $this->project_id);
    ...
    {
        $criteria = new Criteria(ProjectTabPeer::DATABASE_NAME);
        $criteria->add(ProjectTabPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectTab (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectTab Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectTabPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectTabPeer();
        }
    ...
    public function getProject(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProject === null && ($this->project_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProject->addProjectTabs($this);
             */
        }
     ...
     * If this ProjectTab is new, it will return
    ...
    public function setProjectStorys(PropelCollection $projectStorys, PropelPDO $con = null)
    {
        ...
        foreach ($projectStorysToDelete as $projectStoryRemoved) {
            $projectStoryRemoved->setProjectTab(null);
        }
    ...
    protected function doAddProjectStory($projectStory)
    {
        ...
        $projectStory->setProjectTab($this);
    }
    ...
    public function removeProjectStory($projectStory)
    {
        if ($this->getProjectStorys()->contains($projectStory)) {
            ...
            $projectStory->setProjectTab(null);
        }
     ...
     * Otherwise if this ProjectTab is new, it will return
     * an empty collection; or if this ProjectTab has previously
     * been saved, it will retrieve related ProjectStorys from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ProjectTab.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|ProjectStory[] List of ProjectStory objects
     */
    public function getProjectStorysJoinProject($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectStoryQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(ProjectTabPeer::DEFAULT_STRING_FORMAT);
    }
