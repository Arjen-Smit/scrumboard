...
abstract class BaseCustomer extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'ScrumBoard\\CustomerPeer';
    ...
    public function setProjects(PropelCollection $projects, PropelPDO $con = null)
    {
        ...
        $this->projectsScheduledForDeletion = unserialize(serialize($projectsToDelete));

        foreach ($projectsToDelete as $projectRemoved) {
            $projectRemoved->setCustomer(null);
        }
