...
use \PropelException;
use \PropelPDO;
use ScrumBoard\CustomerPeer;
use ScrumBoard\User;
use ScrumBoard\UserPeer;
use ScrumBoard\map\UserTableMap;
...
abstract class BaseUserPeer
{
    ...
    const OM_CLASS = 'ScrumBoard\\User';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Username', 'Password', 'Fullname', 'Email', 'CompanyId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'username', 'password', 'fullname', 'email', 'companyId', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID, UserPeer::USERNAME, UserPeer::PASSWORD, UserPeer::FULLNAME, UserPeer::EMAIL, UserPeer::COMPANY_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USERNAME', 'PASSWORD', 'FULLNAME', 'EMAIL', 'COMPANY_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'username', 'password', 'fullname', 'email', 'company_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Username' => 1, 'Password' => 2, 'Fullname' => 3, 'Email' => 4, 'CompanyId' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'username' => 1, 'password' => 2, 'fullname' => 3, 'email' => 4, 'companyId' => 5, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID => 0, UserPeer::USERNAME => 1, UserPeer::PASSWORD => 2, UserPeer::FULLNAME => 3, UserPeer::EMAIL => 4, UserPeer::COMPANY_ID => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USERNAME' => 1, 'PASSWORD' => 2, 'FULLNAME' => 3, 'EMAIL' => 4, 'COMPANY_ID' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'username' => 1, 'password' => 2, 'fullname' => 3, 'email' => 4, 'company_id' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserPeer::COMPANY_ID);
        } else {
    ...
    public static function doCountJoinCustomer(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(UserPeer::COMPANY_ID, CustomerPeer::ID, $join_behavior);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (User) to the collection in $obj2 (Customer)
                $obj2->addUser($obj1);
