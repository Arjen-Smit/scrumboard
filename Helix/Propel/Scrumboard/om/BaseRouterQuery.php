...
/**
 * Base class that represents a query for the 'Router' table.
 *
 *
 *
 * @method RouterQuery orderById($order = Criteria::ASC) Order by the id column
 * @method RouterQuery orderByActive($order = Criteria::ASC) Order by the active column
 * @method RouterQuery orderByLink($order = Criteria::ASC) Order by the link column
 * @method RouterQuery orderByAction($order = Criteria::ASC) Order by the action column
 *
 * @method RouterQuery groupById() Group by the id column
 * @method RouterQuery groupByActive() Group by the active column
 * @method RouterQuery groupByLink() Group by the link column
 * @method RouterQuery groupByAction() Group by the action column
 *
 ...
 *
 * @method Router findOneByActive(boolean $active) Return the first Router filtered by the active column
 * @method Router findOneByLink(string $link) Return the first Router filtered by the link column
 * @method Router findOneByAction(string $action) Return the first Router filtered by the action column
 *
 * @method array findById(int $id) Return Router objects filtered by the id column
 * @method array findByActive(boolean $active) Return Router objects filtered by the active column
 * @method array findByLink(string $link) Return Router objects filtered by the link column
 * @method array findByAction(string $action) Return Router objects filtered by the action column
 *
...
abstract class BaseRouterQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'scrumboard', $modelName = 'Router', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `active`, `link`, `action` FROM `Router` WHERE `id` = :p0';
        try {
    ...
    public function filterByActive($active = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(RouterPeer::ACTIVE, $active, $comparison);
    }
    ...
    public function filterByLink($link = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(RouterPeer::LINK, $link, $comparison);
    }
    ...
    public function filterByAction($action = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(RouterPeer::ACTION, $action, $comparison);
    }
