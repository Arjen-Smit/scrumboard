...
use \PropelException;
use \PropelPDO;
use ScrumBoard\GroupPeer;
use ScrumBoard\UserGroup;
use ScrumBoard\UserGroupPeer;
use ScrumBoard\UserPeer;
use ScrumBoard\map\UserGroupTableMap;

/**
 * Base static class for performing query and update operations on the 'user_group' table.
 *
 *
 *
...
abstract class BaseUserGroupPeer
{
    ...
    const OM_CLASS = 'ScrumBoard\\UserGroup';

    /** the related TableMap class for this table */
    const TM_CLASS = 'UserGroupTableMap';
    ...
    const USER_ID = 'user_group.user_id';

    /** the column name for the group_id field */
    const GROUP_ID = 'user_group.group_id';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (UserGroupPeer::USER_ID, UserGroupPeer::GROUP_ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (UserGroupPeer::USER_ID => 0, UserGroupPeer::GROUP_ID => 1, ),
    ...
    public static function translateFieldName($name, $fromType, $toType)
    {
        ...
        $key = isset(UserGroupPeer::$fieldKeys[$fromType][$name]) ? UserGroupPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(UserGroupPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, UserGroupPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return UserGroupPeer::$fieldNames[$type];
    }
     ...
     * @param      string $column The column name for current table. (i.e. UserGroupPeer::COLUMN_NAME).
     * @return string
     */
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(UserGroupPeer::USER_ID);
            $criteria->addSelectColumn(UserGroupPeer::GROUP_ID);
        } else {
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setPrimaryTableName(UserGroupPeer::TABLE_NAME);
        ...
        $criteria->setDbName(UserGroupPeer::DATABASE_NAME); // Set the correct dbName
    ...
    {
        return UserGroupPeer::populateObjects(UserGroupPeer::doSelectStmt($criteria, $con));
    }
    /**
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(UserGroupPeer::DATABASE_NAME);
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            UserGroupPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(UserGroupPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(UserGroupPeer::$instances[$key])) {
                return UserGroupPeer::$instances[$key];
            }
        }
    ...
    /**
     * Method to invalidate the instance pool of all tables related to user_group
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key = UserGroupPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj = UserGroupPeer::getInstanceFromPool($key))) {
                ...
                $obj->hydrate($row);
                $results[] = $obj;
                UserGroupPeer::addInstanceToPool($obj, $key);
            } // if key exists
        }
        $stmt->closeCursor();
    ...
    {
        $key = UserGroupPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = UserGroupPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + UserGroupPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = UserGroupPeer::OM_CLASS;
            $obj = new $cls();
    ...
    public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(UserGroupPeer::USER_ID, UserPeer::ID, $join_behavior);
    ...
    public static function doCountJoinGroup(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(UserGroupPeer::GROUP_ID, GroupPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of UserGroup objects pre-filled with their User objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        UserGroupPeer::addSelectColumns($criteria);
        $startcol = UserGroupPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = UserGroupPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = UserGroupPeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                UserGroupPeer::addInstanceToPool($obj1, $key1);
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (UserGroup) to $obj2 (User)
    ...
    /**
     * Selects a collection of UserGroup objects pre-filled with their Group objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of UserGroup objects.
    ...
    public static function doSelectJoinGroup(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (UserGroup) to $obj2 (Group)
                $obj2->addUserGroup($obj1);
    ...
    /**
     * Selects a collection of UserGroup objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        UserGroupPeer::addSelectColumns($criteria);
        $startcol2 = UserGroupPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (UserGroup) to the collection in $obj2 (User)
                $obj2->addUserGroup($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (UserGroup) to the collection in $obj3 (Group)
    ...
    /**
     * Selects a collection of UserGroup objects pre-filled with all related objects except User.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = UserGroupPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (UserGroup) to the collection in $obj2 (Group)
                $obj2->addUserGroup($obj1);
    ...
    /**
     * Selects a collection of UserGroup objects pre-filled with all related objects except Group.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    {
        return Propel::getDatabaseMap(UserGroupPeer::DATABASE_NAME)->getTable(UserGroupPeer::TABLE_NAME);
    }
     ...
     *
     * @param      mixed $values Criteria or UserGroup object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria = $values->buildCriteria(); // build Criteria from UserGroup object
        }
    ...
    /**
     * Performs an UPDATE on the database, given a UserGroup or Criteria object.
     *
     * @param      mixed $values Criteria or UserGroup object containing data that is used to create the UPDATE statement.
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(UserGroupPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(UserGroupPeer::USER_ID);
            $value = $criteria->remove(UserGroupPeer::USER_ID);
            if ($value) {
                $selectCriteria->add(UserGroupPeer::USER_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(UserGroupPeer::TABLE_NAME);
            }

            $comparison = $criteria->getComparison(UserGroupPeer::GROUP_ID);
            $value = $criteria->remove(UserGroupPeer::GROUP_ID);
            if ($value) {
                $selectCriteria->add(UserGroupPeer::GROUP_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(UserGroupPeer::TABLE_NAME);
            }

        } else { // $values is UserGroup object
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(UserGroupPeer::TABLE_NAME, $con, UserGroupPeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            UserGroupPeer::clearInstancePool();
            UserGroupPeer::clearRelatedInstancePool();
            $con->commit();
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            UserGroupPeer::removeInstanceFromPool($values);
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(UserGroupPeer::USER_ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(UserGroupPeer::GROUP_ID, $value[1]));
                $criteria->addOr($criterion);
                // we can invalidate the cache for this single PK
                UserGroupPeer::removeInstanceFromPool($value);
            }
        }
    ...
    /**
     * Validates all modified columns of given UserGroup object.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        return BasePeer::doValidate(UserGroupPeer::DATABASE_NAME, UserGroupPeer::TABLE_NAME, $columns);
    }
