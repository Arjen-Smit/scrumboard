 ...
 *
 * @method CustomerQuery leftJoinProject($relationAlias = null) Adds a LEFT JOIN clause to the query using the Project relation
 * @method CustomerQuery rightJoinProject($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Project relation
 * @method CustomerQuery innerJoinProject($relationAlias = null) Adds a INNER JOIN clause to the query using the Project relation
 *
...
abstract class BaseCustomerQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'scrumboard', $modelName = 'ScrumBoard\\Customer', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `name` FROM `company` WHERE `id` = :p0';
        try {
    ...
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof User) {
            return $this
                ->addUsingAlias(CustomerPeer::ID, $user->getCompanyId(), $comparison);
    ...
    public function filterByProject($project, $comparison = null)
    {
        if ($project instanceof Project) {
            return $this
                ->addUsingAlias(CustomerPeer::ID, $project->getCompanyId(), $comparison);
