...
/**
 * Base class that represents a row from the 'project_user' table.
 *
 *
 *
...
abstract class BaseProjectUser extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'ScrumBoard\\ProjectUserPeer';
     ...
     * @return ProjectUser The current object (for fluent API support)
     */
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->project_id !== $v) {
            $this->project_id = $v;
            $this->modifiedColumns[] = ProjectUserPeer::PROJECT_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = ProjectUserPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectUserPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectUserQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProjectUserPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectUserPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(ProjectUserPeer::PROJECT_ID)) {
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectUser'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectUser'][serialize($this->getPrimaryKey())] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectUserPeer::PROJECT_ID)) $criteria->add(ProjectUserPeer::PROJECT_ID, $this->project_id);
    ...
    {
        $criteria = new Criteria(ProjectUserPeer::DATABASE_NAME);
        $criteria->add(ProjectUserPeer::USER_ID, $this->user_id);
        $criteria->add(ProjectUserPeer::PROJECT_ID, $this->project_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getUserId()) && (null === $this->getProjectId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectUser (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectUser Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(ProjectUserPeer::DEFAULT_STRING_FORMAT);
    }
