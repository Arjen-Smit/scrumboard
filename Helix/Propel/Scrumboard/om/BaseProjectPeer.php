...
use ScrumBoard\map\ProjectTableMap;
...
abstract class BaseProjectPeer
{
    ...
    const OM_CLASS = 'ScrumBoard\\Project';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'CompanyId', 'Name', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'companyId', 'name', ),
        BasePeer::TYPE_COLNAME => array (ProjectPeer::ID, ProjectPeer::COMPANY_ID, ProjectPeer::NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'COMPANY_ID', 'NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'company_id', 'name', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'CompanyId' => 1, 'Name' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'companyId' => 1, 'name' => 2, ),
        BasePeer::TYPE_COLNAME => array (ProjectPeer::ID => 0, ProjectPeer::COMPANY_ID => 1, ProjectPeer::NAME => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'COMPANY_ID' => 1, 'NAME' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'company_id' => 1, 'name' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ProjectPeer::COMPANY_ID);
    ...
    public static function doCountJoinCustomer(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ProjectPeer::COMPANY_ID, CustomerPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Project objects pre-filled with their Customer objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinCustomer(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Project) to $obj2 (Customer)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Project) to the collection in $obj2 (Customer)
                $obj2->addProject($obj1);
